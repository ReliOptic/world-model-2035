...
|---|---|---|---|---|
| 2026 | AIxCC 결과 오픈소스화, AI SOC 파일럿이 대기업 수십 곳 진입 | CRS가 OSS 프로젝트 CI에 상시 통합 | AI 오탐/조직 통합 지연 | 80% |
| 2027 | LLM 기반 zero-day 발견-공개 프로세스 제도화 | 소프트웨어 공급망 전반에 자동 패치 파이프라인 | 모델 제공자 간 계약·책임 분쟁 | 65% |
...
| 2030 | 국가급 사이버 공방이 AI-vs-AI 구도로 완전 전환 | 방어 자동화가 중소기업까지 확산 | 규제·책임 공백이 adoption 지연 | 55% |
| 2031 | zero-day 발견 속도가 패치 배포 속도를 상회 | 자동 패치 + verified fix 체인이 표준 | 패치 자동화 실패 시 공급망 대형 사고 | 60% |
| 2032 | AI 사이버 능력이 국가 경제안보 지표로 편입 | 국제 규범 초안 출현 | 규범 공백 + 공격·방어 경쟁 심화 | 55% |
