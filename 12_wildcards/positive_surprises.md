...
|---|---|---|---|---|
| 2026 | SPARC 첫 플라즈마, IsoDDE Phase 1(Eli Lilly·Novartis ~$3B 계약), GNoME 실험 검증 누적(현재 736개 실험 합성 확인) | Willow 후속칩이 `105→1,000` qubit 스케일 실증 | 핵융합 공학 지연, 임상 실패, AI 약물 파이프라인 정체 | 82% |
| 2027 | SPARC `Q>1`, AI 과학자 공저 논문 주요 학술지 다수 진입; GNoME 2.2M 예측 중 380K 안정 후보 — 실험 검증 1% 진행 시 3,800개 실증 | 첫 AI 설계 신약 2상 긍정 중간결과 | 규제·안전 이슈로 AI 설계 신약 임상 지연 | 78% |
| 2028 | Helion Orion `50MW` 온라인(Microsoft PPA, $425M Series F), GNoME 유래 신소재 배터리·촉매 상용 시제품; AI 설계 신약 임상시험 50-100건 가동 | 고체전지·Li-황 등 한 개 이상 학습곡선 재점화 | 신소재 스케일업 실패, 공급망 단절 | 58% |
| 2029 | IBM Starling `200 logical qubits, 100M gate operations`, 첫 AI 설계 신약 3상 진입 | 양자-고전 하이브리드가 신약·촉매·최적화에서 5-10배 가속 | 양자 결맞음·제조 지연, 임상 3상 실패 | 52% |
| 2030 | ARC 그리드 연결 시도(`400MW` 목표), AI-위성 MRV가 `$100B+` 배출권 시장 재설계; ESA Biomass·NASA-ISRO NISAR 위성 데이터 성숙 | 핵융합 상업 2호기 착공, MRV 기반 기후금융 표준화 | 핵융합 상업성 미달, 기후금융 표준 분절 | 48% |
| 2031 | AI 과학자가 단독·주저자급 기여, AI 설계 신약 FDA 승인 사례; N=1 의학 주류화 30-40% 구간 진입 | 2-3개 과학 분야에서 "AI 촉매 패러다임" 공식 인정 | 과학계 역풍, AI 저자성 논쟁 장기화 | 38% |
| 2032 | 핵융합 PPA 확대, 양자 금융·물류 상업응용 `5-10개`, AI 설계 신약 시장 `$10B+`; AlphaFold >200M 단백질·>1M 연구자 성숙 기반 위 IsoDDE 파이프라인 가속 | LCOE 기준 핵융합이 가스복합보다 저렴한 구간 진입 | 가스·원자력이 더 빨리 확장되어 핵융합 상업화 지연 | 30% |
| 2033 | IBM Blue Jay 로드맵 `2000+ logical qubits`, 양자 내성 암호 전환 완료; 개별 돌파 확률 각각 <35% — 동시 실현은 더 낮음 | 양자가 소재·의약·재료에서 1세대 산업혁신 확정 | 양자 상업화가 소수 응용에 국한 | 48% |
| 2034 | AI+로봇이 건설·농업·돌봄에서 노동 부족 완화, 상업 핵융합 1호기 운전; LK-99 류 상온 초전도 재주장 지속 주의(재현 실패 패턴) | 질병 부담 상위 10개 중 3-4개에서 AI 설계 치료제 시판 | 기술 편익이 고소득국 편중, 분배 역풍 | 32% |
| 2035 | 과학적 비연속 3-5건 누적, 장기 성장률 추정 상향 가능; GNoME 기반 실험 검증 누적 10,000+ 후보 실증 예상 | `GNoME + IsoDDE + FunSearch + 핵융합 + 양자` 복수 조합 실현 | 여러 돌파가 기대에 못 미쳐 Hype Cycle 바닥 재진입 | 30% |
