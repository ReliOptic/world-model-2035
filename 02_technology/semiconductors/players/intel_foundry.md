...
|---|---|---|---|---|
| 2026 | Panther Lake 출하(2026-01 광범위 출하 시작), Clearwater Forest 1H, 18A 수율 안정화; Intel 18A: Intel 3 대비 최대 15% 성능/전력, 30% 밀도 개선, RibbonFET+PowerVia | IFS 외부 대형 고객 1-2곳 확정 | 18A 수율 회복 지연, Clearwater Forest 2H 슬립 | 82% |
| 2027 | 14A 양산 준비 단계 진입(2027 양산 목표), Nova Lake 출하; High-NA EXE:5200B 투입으로 14A 물리 병목 해소 기대; 18A Panther Lake 출하 성공이 14A 준비 단계 진입의 근거 — 1조건(수율 달성 여부) | 14A가 18A보다 빠르게 수율 도달 | 14A 지연, 18A 장수 전략으로 선회 | 78% |
| 2028 | 14A 양산 본격화, Diamond Rapids 데이터센터 출하; 리더십이 "기술 명칭"이 아닌 수율·원가·외부 수주로 검증되는 시점 | IFS 외부 매출 의미 있는 규모로 확대 | IFS 외부 수주 저조로 분사·매각 논의 | 48% |
| 2029 | 10A 기술 개발 완료(2028-2029 목표), 차세대 고객 확보; 지난 10년간 반복된 일정 슬립 이력 감안 — 3+ 불확실 조건 | Intel이 사실상 TSMC의 2위 대안으로 복귀 | 10A 일정 슬립, 기술 격차 재확대 | 42% |
| 2030 | 10A 양산 개시, 첨단 패키징(Foveros·EMIB-T) 강화; 비대만 첨단 로직 캐파 ~25-30%(2030 목표)에서 Intel Arizona가 핵심 기여 | 첨단 패키징이 IFS 차별화 축으로 자리 | 팹 가동률 부족으로 CAPEX 부담 누적 | 42% |
| 2031 | Intel은 로직 + 패키징 통합 공급자로 포지셔닝 | AI 가속기 고객(대형 고객 1곳) 확보 | 여전히 자사 CPU/GPU 중심, 외부 매출 제한 | 50% |
| 2032 | 미국 내 첨단 팹 캐파가 안정화, 국가 전략 자산화; CHIPS Act 지원과 Arizona Fab 52 캐파가 지정학 헷지 수요의 실물 기반 | 중국 리스크 헷지 수요가 Intel로 유입 | 지정학 변수 약화 시 고객 다시 TSMC로 회귀 | 55% |
| 2033 | 차세대 노드(10A 이후) 개발 실행; IFS 시장점유율 목표 10-15%(비대만 첨단 노드 기준) 달성 여부가 분기점 | Intel이 2나노 이하에서 TSMC와 병행 경쟁 | 고객 다변화 실패, IFS 축소 | 33% |
| 2034 | 로직·패키징·HBM 연계 생태계 구축 | 미국 중심 AI 공급망의 핵심축 | 미국 지원 축소 시 구조적 취약 | 28% |
| 2035 | Intel은 TSMC의 주요 대안 공급자로 안정적 2위 지위; 첨단 파운드리 점유율 목표 10-15%(TSMC ~60-65% 대비) — 지정학 헷지 자산으로서의 가치가 기술 순위보다 더 큰 변수 | 양사 체제 복원, 시장 이원화 | 자체 제품+IFS 혼합 모델이 장기 구조적 부담 | 45% |
