...
| 2033 | Metaverse + AI 통합 플랫폼에서 구분 가능한 기업 가치가 형성, AR/VR 공간 AI가 별도 사업부로 독립 | 공간 컴퓨팅 시장이 개화하면 Meta가 가장 넓은 하드웨어-소프트웨어-AI 수직통합 보유 | 공간 컴퓨팅 시장 개화가 2035년 이후로 지연되면 장기 베팅의 ROI 미실현 | 22% |
