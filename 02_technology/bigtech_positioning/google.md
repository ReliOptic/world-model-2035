...
| 2027 | Waymo 주간 `1M+` rides, TPU v8/Ironwood Ultra로 NVIDIA 대안 강화 | DeepMind 연구 성과(AlphaFold 후속, AlphaProof 등)가 상용화로 이어짐 | 자율주행 책임/규제, EU DMA 집행이 Cloud/Search 마진을 압박 | 70% |
...
| 2032 | Waymo/TPU/DeepMind가 각각 분사 또는 대형 사업부로 독립 운영 | Alphabet 구조 재편으로 주주가치 극대화 | 조직 관성으로 통합 상태 유지 | 40% |
