# Financial markets: insurance and reinsurance
...
- 핵심 제약은 climate losses, capital costs, reinsurance capacity, regulation이다.
- 선행지표는 insured loss trend, reinsurance pricing, protection gap, withdrawal zones이다.
- 의존 도메인은 Climate, housing, infrastructure, food, and fiscal policy이다.
...
|---|---|---|---|---|
| `insurance_reinsurance_demand` | demand | index | higher_is_capacity | use_base |
| `insurance_reinsurance_capacity` | capacity | index | higher_is_capacity | block |
| `insurance_reinsurance_finance` | finance | index | higher_is_constraint | use_base |

## 2035 기준선 산출 방식

```text
capacity_score = normalized(insurance_reinsurance_capacity)
finance_score = normalized_inverse(insurance_reinsurance_finance)
demand_score = normalized(insurance_reinsurance_demand)
...
Baseline formula: `min(risk capital, premium affordability, adaptation, regulatory support)`.
...
- Base: min(risk capital, premium affordability, adaptation, regulatory support)에 의해 2035 정상 경로를 산출한다.
...
- [fed_annual.md](../08_economics/monetary_policy/fed_annual.md)
- [SYNTHESIS_2035_QUANTITATIVE.md](../13_scenarios/SYNTHESIS_2035_QUANTITATIVE.md)
- [opportunity_radar.md](../15_opportunity_intelligence/opportunity_radar.md)
- [fundamental_line_prediction.md](../00_foundations/fundamental_line_prediction.md)
- [SYNTHESIS_2035_QUANTITATIVE.md](../13_scenarios/SYNTHESIS_2035_QUANTITATIVE.md)

## 정보 출처

- BIS Annual Economic Report 2025, https://www.bis.org/publ/arpdf/ar2025e.htm, 2026-05 확인.
- World Bank Global Economic Prospects, https://www.worldbank.org/en/publication/global-economic-prospects, 2026-05 확인.
