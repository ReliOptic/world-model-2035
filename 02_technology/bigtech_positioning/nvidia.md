...
|---|---|---|---|---|
| 2026 | Blackwell Ultra 피크 램프 + Vera Rubin 초기 출하, 연매출 `280B+ 달러` | Rubin GA가 조기 완료되며 hyperscaler CAPEX가 추가 상향 | HBM4 공급 / 전력 인프라로 출하 병목 | 80% |
| 2027 | Rubin Ultra NVL576 대규모 배치, 매출 `350B 달러+` | 추론 중심 수요가 학습 감소분을 상쇄 | 토큰 가격 하락으로 ASP 압박 | 70% |
| 2028 | Feynman 세대, 네트워킹·CPO 매출이 본격적으로 기여 | NVIDIA 매출의 30%+가 네트워킹·SW·서비스에서 창출 | Google TPU + AWS Trainium 확산으로 점유율 하락 | 60% |
| 2029 | AI 팩토리 레퍼런스 아키텍처 제공자의 지위 유지 | Omniverse·로봇·자율주행 추가 수직 확장 | 반독점 압력, 고객 자체칩 본격화 | 65% |
| 2030 | NVIDIA 매출 `500B 달러+` 가능 | AI 인프라 4강(클라우드 3사 + NVIDIA)에서 이익 절대치 1위 | AI CAPEX 사이클 반전 도래 | 55% |
...
| 2033 | 규제/반독점 압박 본격화 | 일부 사업부 분사 시 지분 가치 재평가 | 분할 명령 / 중국 사업 전면 정리 | 45% |
| 2034 | NVIDIA가 AI 인프라 설계 표준의 핵심 | 경쟁사와 공존하며 마진 유지 | 수요 plateau로 성장 정체 | 55% |
| 2035 | AI 시대 1인자 지위 유지, 그러나 이익/점유는 다극화 | Robotics/auto/sovereign AI 확장 | 단일 사업 집중 리스크 실현 | 60% |
