# Human capital: healthcare workforce
...
- 핵심 제약은 nurses, physicians, caregivers, burnout, migration이다.
- 선행지표는 vacancy rates, training seats, migration flows, wage premia이다.
- 의존 도메인은 Healthcare systems, aging, fiscal policy, and AI care delivery이다.
...
|---|---|---|---|---|
| `healthcare_workforce_demand` | demand | index | higher_is_capacity | use_base |
| `healthcare_workforce_capacity` | capacity | index | higher_is_capacity | block |
| `healthcare_workforce_finance` | finance | index | higher_is_constraint | use_base |

## 2035 기준선 산출 방식

```text
capacity_score = normalized(healthcare_workforce_capacity)
finance_score = normalized_inverse(healthcare_workforce_finance)
demand_score = normalized(healthcare_workforce_demand)
...
Baseline formula: `min(training capacity, retention, immigration, task-shifting, AI augmentation)`.
...
- Base: min(training capacity, retention, immigration, task-shifting, AI augmentation)에 의해 2035 정상 경로를 산출한다.
...
- [displacement_by_sector.md](../08_economics/labor_markets/displacement_by_sector.md)
- [construction_capacity.md](../18_built_environment/construction_capacity.md)
- [hospital_capacity.md](../21_healthcare_systems/hospital_capacity.md)
...
- OECD Skills Outlook 2025, https://www.oecd.org/en/publications/oecd-skills-outlook-2025_26163cd3-en.html, 2026-05 확인.
- ILO World Employment and Social Outlook Trends 2025, https://www.ilo.org/publications/flagship-reports/world-employment-and-social-outlook-trends-2025, 2026-05 확인.
- WHO Health Workforce database, https://www.who.int/data/gho/data/themes/topics/topic-details/GHO/health-workforce, 2026-05 확인.
