...
|---|---|---|---|---|
| 2026 | imec EXE:5200 Q4 자격 취득, Intel 18A 공정 High-NA 통합 검증, NXE:3800E N2 양산 본격화 | Intel이 High-NA로 예상보다 빠르게 14A 수율 확보 | EXE:5200 레지스트 감도-처리량 균형 문제로 자격 취득 지연 | 80% |
...
| 2028 | TSMC A14 High-NA 공정 통합 시작, High-NA 출하 대수 10대 이상 | High-NA 기반 공정 단계 수 대폭 감소로 원가 절감 가시화 | 마스크 결함 검사 장비 공급 병목으로 팹 셋업 지연 | 76% |
...
| 2034 | High-NA 생태계(레지스트·마스크·검사·서비스) 완전 성숙, 장비 대수 100대 이상 | High-NA가 교육·훈련·생산 전 주기에서 비용 효율적 | 고가 장비의 지정학적 독점 심화로 수출통제 리스크 상승 | 30% |
