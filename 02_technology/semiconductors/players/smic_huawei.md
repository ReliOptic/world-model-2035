...
|---|---|---|---|---|
| 2026 | Ascend 910C·910D 중국 내 배포 확대, Kirin 9030 스마트폰 양산, SMIC N+3 캐파 점진적 확대 | Ascend 910D 성능이 H100 80%+ 수준 달성, 중국 AI 자립 가속 | 910D 수율 문제로 중국 AI 기업들의 공급 차질 | 65% |
...
| 2031 | Ascend 시리즈가 중국 내 AI 인프라의 사실상 표준으로 정착 | 글로벌 표준 대비 성능 격차 縮小로 아시아·글로벌 사우스 수출 가능 | 성능 격차 유지로 중국 AI 기업들의 해외 경쟁력 제약 | 50% |
