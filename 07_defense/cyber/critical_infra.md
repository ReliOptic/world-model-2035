...
|---|---|---|---|---|
| 2026 | Volt/Salt Typhoon 후속 공동 advisory 갱신, 통신사·전력사 OT 격리 정책 강화 | AI SOC 파일럿 효과로 dwell time 감소 | 중소 지자체 보안 격차 사고로 드러남 | 82% |
| 2027 | 파이프라인·수도·전력 사업자 zero-trust 의무화 | 민관 위협 인텔 공유 실시간화 | 규제 이행 지연으로 사고 증가 | 79% |
...
| 2031 | OT 자가치유(self-healing) 제어계통 초기 보급 | AI 기반 자동 복구가 주요 grid에 배치 | 자가치유 오작동 리스크 문제 | 38% |
| 2032 | 통신·전력·수도 섹터에 AI 취약점 점검 의무화 | SBOM/SaaS 감사 전면 일원화 | 중소 벤더 컴플라이언스 부담 급증 | 35% |
