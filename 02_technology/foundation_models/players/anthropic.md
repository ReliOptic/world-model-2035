...
| 2027 | 장기 기억·다중 에이전트 협업 아키텍처 공식 제품화, ASL-4 정의 공개 초안 | 해석가능성 연구가 실질 배포 게이트 설계로 진입 | ASL-4 기준 합의 실패 시 frontier 고객 신뢰 흔들림 | 75% |
...
| 2030 | RSP v4/v5 세대 공식화, 최소 1회 ASL-4 수준 역량 공식 선언 | AI 안전 과학이 peer-reviewed 분야로 성숙 | frontier 사고(incident) 발생 시 전체 배포 위축 | 40% |
