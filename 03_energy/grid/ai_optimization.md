...
|---|---|---|---|---|
| 2026 | 대형 부하 접속 규칙, co-location 심사, AI 수요 예측 고도화가 정책 중심이 된다 | FERC와 유사 규제기관이 빠르게 표준을 정리한다 | 접속 지연과 비용분쟁으로 데이터센터 프로젝트가 밀린다 | 82% |
| 2027 | 유틸리티들이 수요예측, 고장예측, 혼잡관리에서 AI 도구를 표준 보조계층으로 채택하기 시작한다 | 운영비 절감 효과가 확인돼 확산이 빨라진다 | 데이터 품질과 보안 이슈로 도입이 제한된다 | 78% |
...
| 2030 | 데이터센터 전력 수요가 IEA 기준선에 근접하며 전력계획의 핵심 변수로 고정된다 | 재생·저장·수요반응이 빠르게 확충돼 충격을 흡수한다 | 지역별 전력 부족과 가격 급등이 반복된다 | 35% |
