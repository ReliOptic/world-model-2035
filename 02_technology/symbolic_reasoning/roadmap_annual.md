...
|---|---|---|---|---|
| 2026 | AlphaProof/Gemini Deep Think 계열이 IMO 모든 문제 완전 풀이, AI for Math 프로그램 첫 성과 발표 | Lean 기반 AI 증명 시스템이 Putnam·Fields 수준 미해결 문제 1개 이상을 진전 | 자연어 증명 수준은 높지만 형식 증명(Lean) 통합에서 확장성 문제 발견 | 82% |
| 2027 | Lean/Coq 기반 AI 증명 보조기가 주요 대학원 수학·CS 커리큘럼에 공식 도구로 채택 | AI 형식 증명 보조기가 미해결 정리 1개의 완전 증명에 기여 | 형식화(formalization) 비용이 너무 높아 실용 연구에서 보급이 늦음 | 78% |
